...
export default function SignupPage() {
    ...
    return (
      <Card className="border-0 shadow-none">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Kami mengirim link pendaftaran ke <strong>{email}</strong>.
            <br />
            Klik link tersebut untuk membuat akun.
          </CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card className="border-0 shadow-none">
      <CardHeader>
        <CardTitle className="text-2xl">Buat Akun SafeWallet</CardTitle>
        <CardDescription>Gratis selamanya. Tanpa kartu kredit.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <p className="text-center text-xs text-muted-foreground">
          ...
          <Link href="#" className="underline">Syarat & Ketentuan</Link> dan{" "}
          <Link href="#" className="underline">Kebijakan Privasi</Link> kami.
        </p>
      </CardContent>
    </Card>
  );
